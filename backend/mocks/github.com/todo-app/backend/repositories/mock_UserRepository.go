...
func (_m *MockUserRepository) SearchUsers(ctx context.Context, query string, excludeUserID uint) ([]models.User, error) {
...
//   - query string
//   - excludeUserID uint
func (_e *MockUserRepository_Expecter) SearchUsers(ctx interface{}, query interface{}, excludeUserID interface{}) *MockUserRepository_SearchUsers_Call {
	return &MockUserRepository_SearchUsers_Call{Call: _e.mock.On("SearchUsers", ctx, query, excludeUserID)}
}

func (_c *MockUserRepository_SearchUsers_Call) Run(run func(ctx context.Context, query string, excludeUserID uint)) *MockUserRepository_SearchUsers_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockUserRepository_SearchUsers_Call) Return(_a0 []models.User, _a1 error) *MockUserRepository_SearchUsers_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockUserRepository_SearchUsers_Call) RunAndReturn(run func(context.Context, string, uint) ([]models.User, error)) *MockUserRepository_SearchUsers_Call {
	_c.Call.Return(run)
	return _c
}

// UpdatePassword provides a mock function with given fields: ctx, userID, hashedPassword
func (_m *MockUserRepository) UpdatePassword(ctx context.Context, userID uint, hashedPassword string) error {
...
func (_e *MockUserRepository_Expecter) UpdatePassword(ctx interface{}, userID interface{}, hashedPassword interface{}) *MockUserRepository_UpdatePassword_Call {
	return &MockUserRepository_UpdatePassword_Call{Call: _e.mock.On("UpdatePassword", ctx, userID, hashedPassword)}
}

func (_c *MockUserRepository_UpdatePassword_Call) Run(run func(ctx context.Context, userID uint, hashedPassword string)) *MockUserRepository_UpdatePassword_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockUserRepository_UpdatePassword_Call) RunAndReturn(run func(context.Context, uint, string) error) *MockUserRepository_UpdatePassword_Call {
	_c.Call.Return(run)
	return _c
}
